# USAGE
# python train_decay.py --checkpoints output/checkpoints
# python train_decay.py --checkpoints output/checkpoints --model output/checkpoints/epoch_25.hdf5 --start-epoch 25
# python train_decay.py --model output/anpr_decay.hdf5 --output output
...
ap.add_argument("-o", "--output", required=True,
                help="path to output directory (output, plots, etc.)")
